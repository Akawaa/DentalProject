        ...
        <div class="col-xs-6 col-xs-offset-3">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <input type="checkbox" name="job_completed" id="job_completed" value="1" <?php if(set_value('job_completed',$job_done['job_complete'])==1) echo 'checked' ;?> onchange="priceTreatment();"> Completed<br>
                    <br>
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <input type="number" min="0" class="form-control" id="price"  name="job_price_incl_tax" <?php if(set_value('job_completed',$job_done['job_complete'])!=1) echo 'disabled' ;?> value="<?= set_value('job_price_incl_tax',$job_done['job_price_incl_tax']) ?>" >
...
<div class="col-xs-12">
    <input type="submit" class="btn btn-xs btn-success" style="padding: 10px 55px;margin-right:9.7em; " name="sub_new" value="Update">
